...
// function selectTask(position, complete) {
//   cy.findAllByIconName(complete ? "check" : "assignment").each(
//     (value, index) => {
//       if (index === position - 1) {
//         cy.wrap(value).should("be.visible").click()
//       }
//     },
//   )
//   // .then((items) =>
...
// it.only("TaskList count remains in sync when operating on tasks create/check/uncheck/delete-checked/delete-unchecked", () => {
//   visitListPage()
